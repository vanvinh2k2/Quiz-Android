...
public class UpdateUserActivity extends AppCompatActivity {
    ...
    private void update(String u_id) {
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isKiemTra()) {
                    ...
                    disposable.add(apiQuiz.update_user(u_id,name1,pass1,address1)
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())
                            .subscribe(
                                    receiverModel -> {
                                        if(receiverModel.isSuccess()){
                                            Toast.makeText(UpdateUserActivity.this, receiverModel.getResult()+"", Toast.LENGTH_SHORT).show();
                                            startActivity(new Intent(getApplicationContext(),ManagerUserActivity.class));
                                        }
                                    },
                                    throwable -> {
                                        Toast.makeText(UpdateUserActivity.this, throwable.getMessage()+"", Toast.LENGTH_SHORT).show();
                                    }
                            ));
                }
            }
